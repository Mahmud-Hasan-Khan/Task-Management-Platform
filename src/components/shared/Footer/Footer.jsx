...
const Footer = () => {
    return (
        <div className='bg-black p-10 rounded-md mt-10'>
            <div className="footer">
                <aside>
                    <Link to='/'><img className='w-1/4' src={logoImg} alt="" /></Link>
                ...
                <nav>
                    ...
                    <Link className="text-[#cecaca] hover:underline">Email: info@medicare.com</Link>
                    <Link className="text-[#cecaca] hover:underline">Web: www.medicare.com</Link>
            ...
            <div className='text-center grid grid-cols-1 lg:grid-cols-1 p-10'>
                <div>
            ...
            <p className='text-[#cecaca] text-center text-sm'>Copyright © 2023 - All right reserved by MediCare Ltd</p>
        </div >
