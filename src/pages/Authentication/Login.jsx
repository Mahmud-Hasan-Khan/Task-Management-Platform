                    ...
                    >
                        <div className='space-y-4'>
                            ...
                            <div>
                                ...
                                <div className="relative input border rounded-md border-gray-300 flex justify-items-start bg-base-200 items-center mt-2">
                                    <input
                                        ...
                                        id='password'
                                        required
                                        className='w-full px-0 py-1 focus:outline-[#00d260] bg-base-200'
                                    />
                                    <button
                                        type="button"
